...
static const _EstimatorAidSrcBaroHgt_type_support_symbol_names_t _EstimatorAidSrcBaroHgt_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs, msg, EstimatorAidSrcBaroHgt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, EstimatorAidSrcBaroHgt)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4_msgs, msg, EstimatorAidSrcBaroHgt)() {
  return &::px4_msgs::msg::rosidl_typesupport_c::EstimatorAidSrcBaroHgt_message_type_support_handle;
}
