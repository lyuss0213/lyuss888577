...
{
  px4_msgs__msg__ManualControlInput * msg = (px4_msgs__msg__ManualControlInput *)malloc(sizeof(px4_msgs__msg__ManualControlInput));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__ManualControlInput__Sequence__init(px4_msgs__msg__ManualControlInput__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__ManualControlInput *)calloc(size, sizeof(px4_msgs__msg__ManualControlInput));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__ManualControlInput__Sequence * array = (px4_msgs__msg__ManualControlInput__Sequence *)malloc(sizeof(px4_msgs__msg__ManualControlInput__Sequence));
  if (!array) {
    return NULL;
  }
