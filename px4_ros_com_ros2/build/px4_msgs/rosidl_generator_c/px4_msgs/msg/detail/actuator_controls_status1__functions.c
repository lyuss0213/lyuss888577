...
{
  px4_msgs__msg__ActuatorControlsStatus1 * msg = (px4_msgs__msg__ActuatorControlsStatus1 *)malloc(sizeof(px4_msgs__msg__ActuatorControlsStatus1));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__ActuatorControlsStatus1__Sequence__init(px4_msgs__msg__ActuatorControlsStatus1__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__ActuatorControlsStatus1 *)calloc(size, sizeof(px4_msgs__msg__ActuatorControlsStatus1));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__ActuatorControlsStatus1__Sequence * array = (px4_msgs__msg__ActuatorControlsStatus1__Sequence *)malloc(sizeof(px4_msgs__msg__ActuatorControlsStatus1__Sequence));
  if (!array) {
    return NULL;
  }
