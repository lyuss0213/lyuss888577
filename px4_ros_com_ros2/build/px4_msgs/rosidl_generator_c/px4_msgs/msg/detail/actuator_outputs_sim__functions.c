...
{
  px4_msgs__msg__ActuatorOutputsSim * msg = (px4_msgs__msg__ActuatorOutputsSim *)malloc(sizeof(px4_msgs__msg__ActuatorOutputsSim));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__ActuatorOutputsSim__Sequence__init(px4_msgs__msg__ActuatorOutputsSim__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__ActuatorOutputsSim *)calloc(size, sizeof(px4_msgs__msg__ActuatorOutputsSim));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__ActuatorOutputsSim__Sequence * array = (px4_msgs__msg__ActuatorOutputsSim__Sequence *)malloc(sizeof(px4_msgs__msg__ActuatorOutputsSim__Sequence));
  if (!array) {
    return NULL;
  }
