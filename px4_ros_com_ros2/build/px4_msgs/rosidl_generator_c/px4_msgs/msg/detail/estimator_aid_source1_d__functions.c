...
{
  px4_msgs__msg__EstimatorAidSource1D * msg = (px4_msgs__msg__EstimatorAidSource1D *)malloc(sizeof(px4_msgs__msg__EstimatorAidSource1D));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorAidSource1D__Sequence__init(px4_msgs__msg__EstimatorAidSource1D__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__EstimatorAidSource1D *)calloc(size, sizeof(px4_msgs__msg__EstimatorAidSource1D));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__EstimatorAidSource1D__Sequence * array = (px4_msgs__msg__EstimatorAidSource1D__Sequence *)malloc(sizeof(px4_msgs__msg__EstimatorAidSource1D__Sequence));
  if (!array) {
    return NULL;
  }
