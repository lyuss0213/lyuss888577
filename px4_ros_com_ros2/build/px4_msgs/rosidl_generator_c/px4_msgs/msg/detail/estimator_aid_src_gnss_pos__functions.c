...
{
  px4_msgs__msg__EstimatorAidSrcGnssPos * msg = (px4_msgs__msg__EstimatorAidSrcGnssPos *)malloc(sizeof(px4_msgs__msg__EstimatorAidSrcGnssPos));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__EstimatorAidSrcGnssPos__Sequence__init(px4_msgs__msg__EstimatorAidSrcGnssPos__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__EstimatorAidSrcGnssPos *)calloc(size, sizeof(px4_msgs__msg__EstimatorAidSrcGnssPos));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__EstimatorAidSrcGnssPos__Sequence * array = (px4_msgs__msg__EstimatorAidSrcGnssPos__Sequence *)malloc(sizeof(px4_msgs__msg__EstimatorAidSrcGnssPos__Sequence));
  if (!array) {
    return NULL;
  }
