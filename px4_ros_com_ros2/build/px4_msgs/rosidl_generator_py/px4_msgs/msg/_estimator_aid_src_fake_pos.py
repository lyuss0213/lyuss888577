...
class Metaclass_EstimatorAidSrcFakePos(type):
    """Metaclass of message 'EstimatorAidSrcFakePos'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.EstimatorAidSrcFakePos')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__estimator_aid_src_fake_pos
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__estimator_aid_src_fake_pos
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__estimator_aid_src_fake_pos
            cls._TYPE_SUPPORT = module.type_support_msg__msg__estimator_aid_src_fake_pos
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__estimator_aid_src_fake_pos
...
class EstimatorAidSrcFakePos(metaclass=Metaclass_EstimatorAidSrcFakePos):
    """Message class 'EstimatorAidSrcFakePos'."""
    ...
    _fields_and_field_types = {
        ...
        'device_id': 'uint32',
        'time_last_fuse': 'uint64[2]',
        'observation': 'float[2]',
        'observation_variance': 'float[2]',
        'innovation': 'float[2]',
        'innovation_variance': 'float[2]',
        'test_ratio': 'float[2]',
        'fusion_enabled': 'boolean[2]',
        'innovation_rejected': 'boolean[2]',
        'fused': 'boolean[2]',
    }
    ...
    def __init__(self, **kwargs):
        ...
        if 'time_last_fuse' not in kwargs:
            self.time_last_fuse = numpy.zeros(2, dtype=numpy.uint64)
        else:
            self.time_last_fuse = numpy.array(kwargs.get('time_last_fuse'), dtype=numpy.uint64)
            assert self.time_last_fuse.shape == (2, )
    ...
    def time_last_fuse(self, value):
        if isinstance(value, numpy.ndarray):
            ...
            assert value.size == 2, \
                "The 'time_last_fuse' numpy.ndarray() must have a size of 2"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'time_last_fuse' field must be a set or sequence with length 2 and each value of type 'int' and each unsigned integer in [0, 18446744073709551615]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'fusion_enabled' field must be a set or sequence with length 2 and each value of type 'bool'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, bool) for v in value) and
                 True), \
                "The 'innovation_rejected' field must be a set or sequence with length 2 and each value of type 'bool'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, bool) for v in value) and
                 True), \
                "The 'fused' field must be a set or sequence with length 2 and each value of type 'bool'"
        self._fused = value
