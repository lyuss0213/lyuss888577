...
bool px4_msgs__msg__estimator_aid_source2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_aid_source2_d.EstimatorAidSource2D", full_classname_dest, 58) == 0);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_aid_source2_d__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorAidSource2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_aid_source2_d");
