...
bool px4_msgs__msg__estimator_aid_src_rng_hgt__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._estimator_aid_src_rng_hgt.EstimatorAidSrcRngHgt", full_classname_dest, 61) == 0);
  }
  px4_msgs__msg__EstimatorAidSrcRngHgt * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__estimator_aid_src_rng_hgt__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EstimatorAidSrcRngHgt */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._estimator_aid_src_rng_hgt");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EstimatorAidSrcRngHgt");
  ...
  px4_msgs__msg__EstimatorAidSrcRngHgt * ros_message = (px4_msgs__msg__EstimatorAidSrcRngHgt *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
