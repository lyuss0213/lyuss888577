...
class Metaclass_EstimatorAidSrcBaroHgt(type):
    """Metaclass of message 'EstimatorAidSrcBaroHgt'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.EstimatorAidSrcBaroHgt')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__estimator_aid_src_baro_hgt
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__estimator_aid_src_baro_hgt
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__estimator_aid_src_baro_hgt
            cls._TYPE_SUPPORT = module.type_support_msg__msg__estimator_aid_src_baro_hgt
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__estimator_aid_src_baro_hgt
...
class EstimatorAidSrcBaroHgt(metaclass=Metaclass_EstimatorAidSrcBaroHgt):
    """Message class 'EstimatorAidSrcBaroHgt'."""
