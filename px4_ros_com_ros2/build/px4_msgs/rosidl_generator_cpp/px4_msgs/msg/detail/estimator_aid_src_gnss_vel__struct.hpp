...
#ifndef PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_GNSS_VEL__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_GNSS_VEL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__EstimatorAidSrcGnssVel __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__EstimatorAidSrcGnssVel __declspec(deprecated)
#endif
...
struct EstimatorAidSrcGnssVel_
{
  using Type = EstimatorAidSrcGnssVel_<ContainerAllocator>;

  explicit EstimatorAidSrcGnssVel_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit EstimatorAidSrcGnssVel_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSrcGnssVel
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSrcGnssVel
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcGnssVel_<ContainerAllocator> const>
  ...
  bool operator==(const EstimatorAidSrcGnssVel_ & other) const
  {
...
using EstimatorAidSrcGnssVel =
  px4_msgs::msg::EstimatorAidSrcGnssVel_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_GNSS_VEL__STRUCT_HPP_
