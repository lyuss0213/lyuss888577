...
#ifndef PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_FAKE_POS__STRUCT_HPP_
#define PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_FAKE_POS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_msgs__msg__EstimatorAidSrcFakePos __attribute__((deprecated))
#else
# define DEPRECATED__px4_msgs__msg__EstimatorAidSrcFakePos __declspec(deprecated)
#endif
...
struct EstimatorAidSrcFakePos_
{
  using Type = EstimatorAidSrcFakePos_<ContainerAllocator>;

  explicit EstimatorAidSrcFakePos_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->device_id = 0ul;
      std::fill<typename std::array<uint64_t, 2>::iterator, uint64_t>(this->time_last_fuse.begin(), this->time_last_fuse.end(), 0ull);
      ...
      std::fill<typename std::array<bool, 2>::iterator, bool>(this->fusion_enabled.begin(), this->fusion_enabled.end(), false);
      std::fill<typename std::array<bool, 2>::iterator, bool>(this->innovation_rejected.begin(), this->innovation_rejected.end(), false);
      std::fill<typename std::array<bool, 2>::iterator, bool>(this->fused.begin(), this->fused.end(), false);
    }
  }

  explicit EstimatorAidSrcFakePos_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  ...
  // pointer types
  using RawPtr =
    px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSrcFakePos
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_msgs__msg__EstimatorAidSrcFakePos
    std::shared_ptr<px4_msgs::msg::EstimatorAidSrcFakePos_<ContainerAllocator> const>
  ...
  bool operator==(const EstimatorAidSrcFakePos_ & other) const
  {
...
using EstimatorAidSrcFakePos =
  px4_msgs::msg::EstimatorAidSrcFakePos_<std::allocator<void>>;
...
#endif  // PX4_MSGS__MSG__DETAIL__ESTIMATOR_AID_SRC_FAKE_POS__STRUCT_HPP_
