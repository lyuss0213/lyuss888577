...
static rosidl_typesupport_introspection_c__MessageMember FwVirtualAttitudeSetpoint__rosidl_typesupport_introspection_c__FwVirtualAttitudeSetpoint_message_member_array[13] = {
  {
    "timestamp",  // name
