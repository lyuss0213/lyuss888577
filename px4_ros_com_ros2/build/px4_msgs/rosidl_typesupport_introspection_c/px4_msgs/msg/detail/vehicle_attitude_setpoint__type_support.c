...
static rosidl_typesupport_introspection_c__MessageMember VehicleAttitudeSetpoint__rosidl_typesupport_introspection_c__VehicleAttitudeSetpoint_message_member_array[13] = {
  {
    "timestamp",  // name
