...
static rosidl_typesupport_introspection_c__MessageMember McVirtualAttitudeSetpoint__rosidl_typesupport_introspection_c__McVirtualAttitudeSetpoint_message_member_array[13] = {
  {
    "timestamp",  // name
