...
#include "px4_msgs/msg/detail/estimator_aid_src_gnss_pos__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_msgs::msg::EstimatorAidSrcGnssPos & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs::msg::EstimatorAidSrcGnssPos & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_msgs
max_serialized_size_EstimatorAidSrcGnssPos(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorAidSrcGnssPos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs::msg::EstimatorAidSrcGnssPos *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EstimatorAidSrcGnssPos__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs::msg::EstimatorAidSrcGnssPos *>(
...
{
  return max_serialized_size_EstimatorAidSrcGnssPos(full_bounded, 0);
}

static message_type_support_callbacks_t _EstimatorAidSrcGnssPos__callbacks = {
  "px4_msgs::msg",
...
static rosidl_message_type_support_t _EstimatorAidSrcGnssPos__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EstimatorAidSrcGnssPos__callbacks,
...
{
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorAidSrcGnssPos__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, EstimatorAidSrcGnssPos)() {
  return &px4_msgs::msg::typesupport_fastrtps_cpp::_EstimatorAidSrcGnssPos__handle;
}
