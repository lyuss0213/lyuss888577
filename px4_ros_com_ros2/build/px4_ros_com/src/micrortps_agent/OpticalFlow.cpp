...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@40a4337a
    m_timestamp = 0;
    // m_sensor_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6025e1b6
    m_sensor_id = 0;
    // m_pixel_flow_x_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@22ff4249
    m_pixel_flow_x_integral = 0.0;
    // m_pixel_flow_y_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2d1ef81a
    m_pixel_flow_y_integral = 0.0;
    // m_gyro_x_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c402120
    m_gyro_x_rate_integral = 0.0;
    // m_gyro_y_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@327514f
    m_gyro_y_rate_integral = 0.0;
    // m_gyro_z_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5b12b668
    m_gyro_z_rate_integral = 0.0;
    // m_ground_distance_m com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1165b38
    m_ground_distance_m = 0.0;
    // m_integration_timespan com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c12331b
    m_integration_timespan = 0;
    // m_time_since_last_sonar_update com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7586beff
    m_time_since_last_sonar_update = 0;
    // m_frame_count_since_last_readout com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3b69e7d1
    m_frame_count_since_last_readout = 0;
    // m_gyro_temperature com.eprosima.idl.parser.typecode.PrimitiveTypeCode@815b41f
    m_gyro_temperature = 0;
    // m_quality com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5542c4ed
    m_quality = 0;
    // m_max_flow_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1573f9fc
    m_max_flow_rate = 0.0;
    // m_min_ground_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6150c3ec
    m_min_ground_distance = 0.0;
    // m_max_ground_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@44c03695
    m_max_ground_distance = 0.0;
    // m_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7e6f74c
    m_mode = 0;
