...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c77d488
    m_timestamp = 0;
    // m_nav_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@63376bed
    m_nav_state = 0;
    // m_nav_state_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4145bad8
    m_nav_state_timestamp = 0;
    // m_arming_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d86a6f
    m_arming_state = 0;
    // m_hil_state com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2892d68
    m_hil_state = 0;
    // m_failsafe com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5ab956d7
    m_failsafe = false;
    // m_failsafe_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3646a422
    m_failsafe_timestamp = 0;
    // m_system_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@750e2b97
    m_system_type = 0;
    // m_system_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e27aa33
    m_system_id = 0;
    // m_component_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2e385cce
    m_component_id = 0;
    // m_vehicle_type com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2ddc9a9f
    m_vehicle_type = 0;
    // m_is_vtol com.eprosima.idl.parser.typecode.PrimitiveTypeCode@298a5e20
    m_is_vtol = false;
    // m_is_vtol_tailsitter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a7f1f10
    m_is_vtol_tailsitter = false;
    // m_in_transition_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@46cdf8bd
    m_in_transition_mode = false;
    // m_in_transition_to_fw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f0c8a99
    m_in_transition_to_fw = false;
    // m_rc_signal_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@740cae06
    m_rc_signal_lost = false;
    // m_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@26d9b808
    m_data_link_lost = false;
    // m_data_link_lost_counter com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f78a47e
    m_data_link_lost_counter = 0;
    // m_high_latency_data_link_lost com.eprosima.idl.parser.typecode.PrimitiveTypeCode@644baf4a
    m_high_latency_data_link_lost = false;
    // m_mission_failure com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7526515b
    m_mission_failure = false;
    // m_geofence_violated com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ed4ae0f
    m_geofence_violated = false;
    // m_failure_detector_status com.eprosima.idl.parser.typecode.PrimitiveTypeCode@54c5a2ff
    m_failure_detector_status = 0;
    // m_onboard_control_sensors_present com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6d4d66d2
    m_onboard_control_sensors_present = 0;
    // m_onboard_control_sensors_enabled com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a265ea9
    m_onboard_control_sensors_enabled = 0;
    // m_onboard_control_sensors_health com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11392934
    m_onboard_control_sensors_health = 0;
    // m_latest_arming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6892b3b6
    m_latest_arming_reason = 0;
    // m_latest_disarming_reason com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6e6f2380
    m_latest_disarming_reason = 0;
    // m_armed_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76a4ebf2
    m_armed_time = 0;
    // m_takeoff_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2e8c1c9b
    m_takeoff_time = 0;
    // m_safety_button_available com.eprosima.idl.parser.typecode.PrimitiveTypeCode@53fe15ff
    m_safety_button_available = false;
    // m_safety_off com.eprosima.idl.parser.typecode.PrimitiveTypeCode@449a4f23
    m_safety_off = false;
